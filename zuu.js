...
let Country_Population=document.getElementById('Country-Population');
let Country_Currencey=document.getElementById('Country-Currencey');
const Country_Commman=document.getElementById('Country-Comman');
let searchBtn=document.getElementById('Search');
...
searchBtn.addEventListener('submit', (e) => {
    ...
    fetch(`https://restcountries.com/v3.1/name/${e.target[0].value}`)
        ...
        .then((data) => {
            ...
            Country_Population.textContent=data[0].population;
            Country_Currencey.textContent=data[0].currencies.SOS.name;
            Country_Commman.textContent=data[0].languages;
